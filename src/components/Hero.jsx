                ...
                <div className="container-fluid">
                    <div className="row flex-lg-row flex-md-column">
                        <div className="col-lg-6 col-md-12 content padding mt-5 text-sm-center text-lg-start">
                            <div className=" position-relative d-flex align-items-center justify-content-center text-and-img px-3">
                                <div className=" w-100 my-auto">
                                    <p className='my-auto'>Welcome To Tasty Trials</p>
                                </div>
                                <div className="position-absolute end-0 d-inline-block" style={{ height: "70px", width: "70px" }}><img className='w-100' src={sm1} alt="" /></div>
                            </div>
                            <h1 className='heading-sm my-4'>Tasty Trials Where Taste Brings Precious Memories</h1>
                            <div className="img-text d-flex  align-items-center justify-content-center my-lg-4 mt-md-5 ">
                                <div style={{ height: "100px", width: "100px" }}>
                                    <img className='w-100' src={sm2} alt="" />
                                </div>
                                <p className=' text-md-center'>Are you someone who enjoy great food? If so, welcome to tasty trials Where
                                    we serve up directable dishes for you</p>
                            </div>
                            <div className="button-dev w-100 d-flex align-content-center justify-content-md-start justify-content-center mx-auto my-5 p-lg-0 p-sm-4">
                                <button className="btn shadow">Get Started</button>
                                <div className="watch-btns w-50 d-flex align-content-center  justify-content-center">
                                    <button className='btn shadow w-25 rounded-circle'><i class="fa-solid fa-play"></i></button>
                                    <h5 className=" my-auto">Watch Video</h5>
                                </div>
                            </div>
                            <div className="cutomer-review d-flex flex-md-row flex-column align-items-center align-items-md-start my-5">
